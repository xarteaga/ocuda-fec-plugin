...
#include "ldpc_decoder_cuda_impl.h"
...
ldpc_decoder_cuda_impl::ldpc_decoder_cuda_impl(std::shared_ptr<cuda_ldpc_decoder_backend> backend_) :
...
{
  return std::make_unique<ldpc_decoder_cuda_impl>(std::move(backend));
}
