...
public:
  ...
  using codeblock_decoder_pool = bounded_unique_object_pool<pusch_codeblock_cuda_decoder>;
...
private:
  ...
  ///
  std::array<codeblock_decoder_pool::ptr, MAX_NOF_SEGMENTS> on_use_decoders;
